...
scaledAnomTable <- anomTable1

scaledAnomTable <- scale(anomTable1$Global_active_power, center=1.23, scale=1.06)
scaledAnomTable <- scale(anomTable1$Global_reactive_power, center=0.122, scale=0.112)
scaledAnomTable <- scale(anomTable1$Global_intensity, center=4.64, scale=4.58)
scaledAnomTable <- scale(anomTable1$Sub_metering_3, center=6.17, scale=8.32)
...
anomTestNTimes <- rep(numPoints+1, length(weeks))
